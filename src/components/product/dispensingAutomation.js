            ...
            <div className="LabEquipmentSection">
                ...
                <div className="cardHeadDiscriptios">
                    ...
                    <div className = "CardBody">
                        ...
                        <Link className = "productLink" to='/DispensingAutomation/TechnoFill'><PartnersCard image={TechnoFill} head = {"TechnoFill"} body ={"Safe loading and storage of chemicals and liquid auxiliaries"} /></Link>
