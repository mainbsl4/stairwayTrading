            ...
            <div className="AutomationRetrofitSection">
                ...
                <div className="cardHeadDiscriptios">
                    ...
                    <div className = "CardBody">
                        <Link className = "productLink" to='/Hi'><PartnersCard image={DATEX_SMART_TOUCH_M} head = {"MDatex-smart-touch-M"} body ={"Controller for the production dyeing machine."} /></Link>
                        <Link className = "productLink" to='/Hi'><PartnersCard image={datexSmartTouch_S} head = {"Datex-smart-touch-S"} body ={`"Display: 7,0" TFT, color touchscreen, Internal I/O"`} /></Link>
                        <Link className = "productLink" to='/Hi'><PartnersCard image={plc_master} head = {"DATEX PLC MASTER 841616"} body ={"Interface: Modbus RTU (USB)"} /></Link>
                        <Link className = "productLink" to='/Hi'><PartnersCard image={SAplc_modul_ioLCE} head = {"PLC-module"} body ={"Digital & analog I/O"} /></Link>
                    </div>  
                    {/* <i>CEO/STAIRWAY</i> */}
                </div>
            </div>
