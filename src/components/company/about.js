            ...
            <div className="startSection">
                ...
                <div className="discriptionBox">
                    <div>
                        ...
                        <p>Bringing the latest solutions as our machinery partners introducing those through their rigorous and continuous research on technologies and trends. In every aspect, from Dyeing to finishing, STAIRWAY Trading always offers the latest solutions for our valued customers.</p>
                    </div>
                    {/* <i>CEO/STAIRWAY</i> */}
                </div>
            </div>
